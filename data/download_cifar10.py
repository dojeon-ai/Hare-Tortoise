...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='/home/hojoonlee/assets/CIFAR10/', help='Root directory path')
    ...
    if not os.path.exists(train_dir) or not os.path.exists(val_dir):
        ...
        dataset_train = torchvision.datasets.CIFAR10(root=root_dir, train=True, download=True)
        dataset_val = torchvision.datasets.CIFAR10(root=root_dir, train=False, download=True)
